  ...
  return (
    <div className="flex flex-col py-16 md:px-80 px-10 items-center text-center">
      ...
      <p className="my-5  md:text-3xl text-2xl font-medium">
        ...
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam eius nam deleniti, quae delectus, possimus sit accusantium repellendus deserunt illum expedita cupiditate, culpa sint dicta!
      </p>
